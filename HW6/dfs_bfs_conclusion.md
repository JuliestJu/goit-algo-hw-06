Я використала алгоритми пошуку у глибину (DFS) та пошуку у ширину (BFS) до графа, що представляє мережу київського метрополітену. Давайте порівняємо шляхи, згенеровані кожним з алгоритмів:
